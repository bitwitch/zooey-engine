...
Terrain::Terrain(int grid_x, int grid_y, Loader* loader, Model_Texture* texture) 
:   x         ( grid_x * SIZE )
,   z         ( grid_y * SIZE )
...
Raw_Model Terrain::generate_terrain(Loader* loader) {
    ...
    return loader->load_to_vao(vertices, tex_coords, normals, indices);
}
